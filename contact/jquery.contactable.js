...
(function($){
	...
	$.fn.contactable = function(options) {
		//set default options  
		var defaults = {
			url: 'http://www.readachunk.com/contact/mailcontact.php',
			name: 'Name',
			email: 'Email',
			message : 'Message',
			subject : 'Uhhh feedback from readachunk.com!',
			submit : 'SHOOT!',
			recievedMsg : 'Thanks! You are awesome!',
			notRecievedMsg : 'Sorry but your message could not be sent, try again later or email readachunk@kjer.info.',
			disclaimer: 'Please feel free to get in touch, we value your feedback! (And making new friends)',
			hideOnSubmit: true
		};
